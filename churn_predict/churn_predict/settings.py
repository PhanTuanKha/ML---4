"""
Django settings for churn_predict project.
...
SECRET_KEY = 'django-insecure-e5h(#o63zdwuhel_%93bl)@iz51q!&3x+kr6zelyc$%kcc*0oa'
...
INSTALLED_APPS = [
    ...
    'core', # Thêm app 'core' của bạn vào đây
]
...
ROOT_URLCONF = 'churn_predict.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            BASE_DIR / 'templates', # Thêm dòng này để Django tìm template ở thư mục gốc
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'churn_predict.wsgi.application'
